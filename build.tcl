...
add_file -type verilog "src/ikaopll/IKAOPLL.v"
add_file -type verilog "src/ikaopll/IKAOPLL_dac.v"
add_file -type verilog "src/ikaopll/IKAOPLL_eg.v"
add_file -type verilog "src/ikaopll/IKAOPLL_lfo.v"
add_file -type verilog "src/ikaopll/IKAOPLL_op.v"
add_file -type verilog "src/ikaopll/IKAOPLL_pg.v"
add_file -type verilog "src/ikaopll/IKAOPLL_reg.v"
add_file -type verilog "src/ikaopll/IKAOPLL_primitives.v"
add_file -type verilog "src/ikaopll/IKAOPLL_timinggen.v"
